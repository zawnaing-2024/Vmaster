...
<head>
    ...
    <title><?php echo t('customer_login', 'customer'); ?> - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <h1>👤 <?php echo t('customer_login', 'customer'); ?></h1>
            <p class="subtitle"><?php echo t('login_to_continue', 'customer'); ?></p>
